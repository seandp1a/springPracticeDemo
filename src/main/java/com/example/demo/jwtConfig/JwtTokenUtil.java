...
public class JwtTokenUtil implements Serializable {
    ...
    private static final String secret = "H5ADMIM";
    ...
    public String getAccess(String token) {
        Claims claims = getAllClaimsFromToken(token);
        return claims.get("access").toString();
    }
    ...
    public String generateToken(UserDetails userinfo) {
        ...
        claims.put("access", userinfo.getAuthorities());

        return doGenerateToken(claims, userinfo.getUsername().toString());
    }
